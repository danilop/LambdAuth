...
More details of installing aws CLI can be found [here](http://docs.aws.amazon.com/cli/latest/userguide/installing.html), more details on installing jq can be found [here](https://stedolan.github.io/jq/download/). 
